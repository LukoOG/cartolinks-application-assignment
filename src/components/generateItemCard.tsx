...
export default function itemCard ({ Icon, title, text }) {
	return (
		<div className="w-full max-h-full grid-cols-[1fr_3fr_1fr] items-center grid p-2">
			<div className="h-12 flex items-center justify-center w-12 rounded-xl bg-red-400">
				<Icon color="#fff" fill="#fff" size={24} />
			</div>
